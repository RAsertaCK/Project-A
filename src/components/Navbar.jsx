      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-2 md:hidden">
            ...
            {/* Hamburger Button - TANPA X, HANYA HAMBURGER */}
            <button 
              className="flex flex-col justify-center items-center w-10 h-10 space-y-1.5 z-50 relative bg-gray-100 dark:bg-gray-800 rounded-lg p-2 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors duration-200"
              onClick={toggleMenu}
              aria-label="Toggle menu"
            >
              {/* HAMBURGER LINES - TIDAK PERLU BERUBAH JADI X */}
              <span className="block w-6 h-0.5 bg-gray-800 dark:bg-white transition-all duration-300"></span>
              <span className="block w-6 h-0.5 bg-gray-800 dark:bg-white transition-all duration-300"></span>
              <span className="block w-6 h-0.5 bg-gray-800 dark:bg-white transition-all duration-300"></span>
            </button>
          </div>
        ...
        {/* Mobile Menu Slide Panel - TANPA X BUTTON */}
        <div 
        ...
        >
          ...
          {/* Header Mobile Menu - TANPA X BUTTON */}
